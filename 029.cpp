...
/*
	Przegl¹daj¹c ró¿ne strony, podrêczniki nigdzie nie spotka³em ultra-precyzyjnego wyjaœnienia tego, 
	co za chwilê spróbujê nieudolnie pokazaæ. Wszêdzie s¹ jakieœ niedopowiedzenia, jakieœ nieœcis³oœci definicyjne.
	Wszêdzie a¿ prosi siê o zestaw pytañ. Jestem pewny, ¿e twórcy tych wyjaœnieñ nie odpowiedz¹ jasno na pytanie: 
	"czy osoba, która siê uczy i nie spotka³a siê nigdy z tym zagadnieniem w ogóle zrozumie, co do niej mówimy?" 	
	C++ niekiedy jest w mojej ocenie tak abstrakcyjny, ¿e - po prostu - sprawia du¿¹ trudnoœæ poznawcz¹. 
	Praktyka pokazuje, ¿e pewne rzeczy trudniej opisaæ, a ³atwiej zrozumieæ czym s¹ poprzez prezentacjê tego, co robi¹.
	W procesie edukacji nie raz zdarza³o mi siê - nie wstydzê siê tego powiedzieæ - najpierw zobaczyæ jak coœ dzia³a, 
	nie do koñca to rozumiej¹c a nawet nie potrafi¹c tego wyraŸnie od samego œrodka opisaæ. Zastanawiam siê nawet, czy
	jest to zawsze konieczne? A potem powoli i po pewnym czasie pojawi³o siê takie "aaaa, dobra, wiem!" Zg³êbi³em sens, 
	dzia³anie i istotê tego, co tu siê wyprawia póŸniej. Wielu uczniów korzysta np. ze wskaŸników ale do koñca nie umie 
	o tym opowiedzieæ, co w³aœciwie siê dzieje. Ale z czasem naturalnie staje siê to zrozumia³e. Ucz¹c sam muszê w pe³ni
	zrozumieæ i nie zawsze jest to mo¿liwe "od rêki".
	Podobny problem i podobny mechanizm napotka³em ucz¹c siê o adaptatorach iteratorów. Nawet samo pojêcie trudno wyjaœniæ, poniewa¿ nigdzie
	nie znalaz³em jego bezpoœredniej jasnej definicji. Jest to raczej definicja poprzez opis dzia³ania. To trochê tak
	, jakby bardzo doœwiadczeni programiœci tworz¹cy jêzyk zrealizowali zrozumia³¹ tylko sobie g³êbok¹ abstrakcjê, wpier napisan¹ 
	i dzia³aj¹c¹ a dopiero potem opisali teoretycznie to co wymyœlili. Ten nowe rzeczy trudno jest nauczyæ siê kolejnym osobom, s
	zczególnie nie posiadaj¹cych takiego doœwiadczenia, które sprawia, ¿e jêzyk nie tyle siê "zna" co dog³êbnie rozumie, nim siê 
	wrêcz myœli. Tak. Jêzyk jest czymœ tak ¿ywym, ¿e wymaga sam w sobie pewnej dojrza³oœci i rozumienia. Dlatego bogactwo jêzyka 
	faktycznie zmienia myœlenie a tym samym osoba rozumiej¹ca jêzyk g³êbiej siê nim wyra¿a, pe³niej opisuje to, co myœli.
	Jestem pewny, ¿e moje wyobra¿enie tego, co mogê "napisaæ w tym jêzyku" jest p³ytkie w porównaniu do wyobra¿enia tych, 
	co jêzyk tworzyli i pos³uguj¹ siê nim z rozmachem i obficie. Taka wyobraŸnia, jakie bogactwo jêzyka! Obrazy bowiem 
	porusz¹ tylko zmys³ wzroku, a jêzyk istotê rzeczy! Równie¿ jêzyk C++.
*/
