#pragma once
void _023(); // wstêp 001
void _003(); // inicjalizacj¹ zmiennych z wykorzystaniem nawiasów: () i {} // 002
void _009(); // r-value, l-value  // 003
void _002(); // if, switch z ograniczonym zasiêgiem zmiennej ( + przestrzeñ nazw) // 004
void _010(); // array + wstêp do iteratorów // 005
void _014(); // para, niejawnie podany typ // 006
void _013(); // krotki, niejawnie podany typ // 00701, 00702 
void _001(); // rozpakowywanie // 008
void _008(); // wektory, iteratory rozwiniêcie  // 00901-00902

void _004(); // kolejka o dwóch koñcach deque // 010

void _011(); // list // 11
void _024(); // map/multimap // 12
void _025(); // zbiory, wielozbiory // 13
void _021(); // kontenery nieporz¹dkuj¹ce // 14
...
void _022(); // wt³aczanie referencji
